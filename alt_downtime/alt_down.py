...
class AltDownModelObservatory(Model_observatory):
    def change_scheduled_downtime(self, scheduled_downtime_db):
        ...
        self.sched_downtime_data = ScheduledDowntimeData(
            mjd_start_time,
            scheduled_downtime_db=scheduled_downtime_db)
...
def run_sched(surveys, survey_length=365.25, nside=32, fileroot='baseline_', verbose=False,
              extra_info=None, illum_limit=40., scheduled_downtime_db=None):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--scheduled_downtime", type=str, default="")
    ...
    scheduled_downtime_db = None if args.scheduled_downtime is "" else args.scheduled_downtime
    ...
    fileroot = 'altdown_' + os.path.splitext(scheduled_downtime_db)[0] + '_'
    file_end = ''
